...
The github package is developed on macOS operating systems. The MiXcan pacakge is developed under an open source software R (version 3.5.1). Different versions of R can be downloaded at https://cran.r-project.org/. 
...
Below demonstrates the MiXcan analysis pipeline using a single peusdo gene. 
