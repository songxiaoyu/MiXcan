...
Note: As a proof of concept, a subset of SNPs reported in the mammary tissues in predictdb (https://predictdb.org) were used as the SNP pool for model training. 
